...
sealed class FindAction() : Action {
    ...
    data class SearchMulti(val query: String) : FindAction()
    data class SearchMovie(val query: String) : FindAction()
    data class SearchTv(val query: String) : FindAction()
    data class SearchPeople(val query: String) : FindAction()
